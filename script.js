...
function createTierList(tierListName) {
  ...
  //adding edit functionality to the tier-list-app
  textContainer.addEventListener('dblclick', (event) => {
    ...
    inputItem.addEventListener('blur', () =>
      saveEdit(textContainer, inputItem)
    );
    ...
    textContainer.appendChild(inputItem);
    inputItem.focus();
  });
...
// Edit tier list
function saveEdit(textContainer, inputItem) {
